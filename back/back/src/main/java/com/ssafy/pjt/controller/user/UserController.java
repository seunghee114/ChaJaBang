package com.ssafy.pjt.controller.user;
...
import com.ssafy.pjt.model.service.user.MemberServiceImpl;
...
public class UserController {
	...
	public ResponseEntity<Map<String, Object>> login(
		...
		try {
			UserDTO loginUser = service.login(memberDto);
			if (loginUser != null) {
				String accessToken = jwtService.createAccessToken("userid", loginUser.getUserid());// key, data
				String refreshToken = jwtService.createRefreshToken("userid", loginUser.getUserid());// key, data
				service.saveRefreshToken(memberDto.getUserid(), refreshToken);
...
//		logger.debug("userid : {} ", userid);
		...
		if (jwtService.checkToken(request.getHeader("access-token"))) {
			...
			try {
//				로그인 사용자 정보.
				UserDTO memberDto = service.userInfo(userid);
	...
	@PostMapping("/refresh")
	public ResponseEntity<?> refreshToken(@RequestBody UserDTO memberDto, HttpServletRequest request) throws Exception {
		Map<String, Object> resultMap = new HashMap<>();
		HttpStatus status = HttpStatus.ACCEPTED;
	...
	public ResponseEntity<?> register(@RequestBody UserDTO memberDto) throws Exception{
		int registResult = service.regist(memberDto);
		if(registResult==1) {
